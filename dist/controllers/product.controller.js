    ...
    rest_1.post('/products', {
        responses: {
            '200': {
                ...
                content: { 'application/json': { schema: { 'x-ts-type': product_model_1.Product } } },
            },
        },
    }),
...
__decorate([
    ...
    __param(0, rest_1.param.query.object('where', rest_1.getWhereSchemaFor(product_model_1.Product))),
    __metadata("design:type", Function),
    ...
    rest_1.get('/products', {
        responses: {
            '200': {
                ...
                content: {
                    'application/json': {
                        schema: { type: 'array', items: { 'x-ts-type': product_model_1.Product } },
                    },
                },
            },
        },
    }),
    __param(0, rest_1.param.query.object('filter', rest_1.getFilterSchemaFor(product_model_1.Product))),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
...
__decorate([
    ...
    __param(0, rest_1.requestBody()),
    __param(1, rest_1.param.query.object('where', rest_1.getWhereSchemaFor(product_model_1.Product))),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [product_model_1.Product, Object]),
    __metadata("design:returntype", Promise)
